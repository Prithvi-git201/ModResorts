...
public class WeatherServlet extends HttpServlet {
  ...
  public void init() {
    ...
    this.cachedWeatherApiKey = loadWeatherApiKeyFromSecretsManager();
  }
   ...
   */
  private String loadWeatherApiKeyFromSecretsManager() {
    try {
      ...
      logger.info("Successfully loaded weather API key from AWS Secrets Manager");
      return secret;
      
    } catch (Exception e) {
      logger.warning("Failed to load secret from AWS Secrets Manager, falling back to environment variable: " + e.getMessage());
