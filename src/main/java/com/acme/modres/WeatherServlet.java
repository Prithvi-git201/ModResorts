...
public class WeatherServlet extends HttpServlet {
  ...
  private String configureEnvDiscovery() {
    // Use environment variables for server configuration in containerized environments
    ...
    return serverName + "-" + serverEnv;
  }

  // Removed RMI-based InitialContext setup (setInitialContextProps method)
  // RMI registry dependencies are not suitable for containerized environments
  // For service discovery in containers, use REST APIs with service mesh or AWS Cloud Map
}
